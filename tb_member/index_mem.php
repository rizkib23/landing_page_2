      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
            <a href="home_mem.php" class="btn btn-md btn-success" style="margin-bottom: 10px">TAMBAH DATA</a>
                ...
                <tbody>
                  ...
                  <td><?php echo $no++ ?></td>
                      ...
                      <td class="text-center">
                        <a href="edit_mem.php?id=<?php echo $row['id_member'] ?>" class="btn btn-sm btn-primary">EDIT</a>
                        <a href="hapus_mem.php?id=<?php echo $row['id_member'] ?>" class="btn btn-sm btn-danger">HAPUS</a>
                      </td>
                  </tr>
